            ...
            <div className="flex relative z-30 sm:pb-[60px] pt-[30px] px-4 justify-end  flex-col sm:items-center gap-4 w-full">
              ...
              <div>
                ...
                >
                  ...
                  <li>
                    <a target="_blank" href="https://t.me/fhritpcto">
                      <svg
                        className="h-8 sm:h-14 lg:h-20 w-auto"
                        stroke="currentColor"
                        fill="#0088CC"
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://dexscreener.com/solana/f9wi6f1nxggkbytkudwe7eskhzeapbupyczq7fgavrur"
                    >
                      <svg
                        className="h-8 sm:h-14 lg:h-20 w-auto"
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <li>
                    <a
                      target="_blank"
                      href="https://www.dextools.io/app/en/solana/pair-explorer/F9Wi6F1NxgGkBytKUDwe7ESKhZEApbUpYCZQ7fgaVruR?t=1719046998885"
                    >
                      <svg
                        className="h-8 sm:h-14 lg:h-20 w-auto"
                        xmlns="http://www.w3.org/2000/svg"
              ...
              <div onClick={handleClick}>
                <Button
                  target="_blank"
                  text="Buy Merch"
                  href="https://fhritp-store.company.site/"
                />
              </div>
            </div>
          </section>
